...
\begin{soln}\footnotemark
    ...
    \begin{subproof}
        ...
        Do \( p = 4k + 3 \Rightarrow \frac{p - 1}{2} = 2k + 1 \) là số lẻ, nên:
        \[
            (-1)^{2k + 1} = -1 \Rightarrow 1 \equiv -1 \pmod{p} \Rightarrow 2 \equiv 0 \pmod{p}.
        \]
    ...
    Mặt khác, vì \( 5 \mid d \Rightarrow 5 \mid n^2 d \), mà \( 5 \nmid a^2 + 2, a^2 + 3 \), nên \( n^2 d \ne a^2 + 2, a^2 + 3 \).
