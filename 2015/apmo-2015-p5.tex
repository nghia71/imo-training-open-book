...
\begin{soln}\footnotemark
    ...
    \begin{subproof}
        ...
        \]
        Từ đây suy ra \( (n+2)(n+4)a_{n+1} - (n+3)(n+1)(n+4)a_n = \delta_{n+2} \), nên \( n+4 \mid \delta_{n+2} \Rightarrow \delta_{n+2} = 0 \), dẫn đến:
        \[
    ...
    Vì \( m + 3 \mid a_{m+1} \), đặt \( a_{m+1} = (m+3)k \Rightarrow a_{m+2} = (m+2)(m+4)k \). Khi đó:
    \[
    ...
    Thế \( n = 1 \) ta có \( 3 \mid a_1 \). Đặt \( a_1 = 3c \Rightarrow a_n = c(n+2)n! \) với mọi \( n \ge 1 \).
